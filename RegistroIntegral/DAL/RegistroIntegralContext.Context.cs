...
namespace RegistroIntegral.DAL
{
    ...
    public partial class RegistroIntegralEntities : DbContext
    {
        public RegistroIntegralEntities()
            : base("name=RegistroIntegralEntities")
        {
        }
        ...
        public virtual DbSet<Detalle_Plan> Detalle_Plan { get; set; }
